...
import Messege from "./dashboardpages/messege";
import Notification from "./dashboardpages/notification";
import Service from "./dashboardpages/service";
...
export default function Dashboard(props) {
  ...
  const handleDrawerNavigate = (route) => {
    navigate(`/${route}`);
  };
      ...
      <List>
        {pagesArr.map((x, index) => (
          <ListItem key={x.name} disablePadding>
            <ListItemButton onClick={() => handleDrawerNavigate(x.route)}>
              <ListItemIcon>
